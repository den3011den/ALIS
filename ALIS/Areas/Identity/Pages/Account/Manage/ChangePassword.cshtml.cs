...
namespace ALIS.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage = "Ввод текущего пароля обязателен")]
            [DataType(DataType.Password)]
            [Display(Name = "Текущий пароль")]
            public string OldPassword { get; set; }

            [Required(ErrorMessage = "Ввод нового пароля обязателен")]
            ...
            [Compare("NewPassword", ErrorMessage = "'Новый пароль' но совпадает c 'Новый пароль ещё раз'.")]
